mapkey $F9 @MAPKEY_LABEL[]Layers Datums Toggle.Loaded.Show;\
...
;\
! This run the .llds mapkey to hide the defined datum layers;\
%.llds;\
;\
...
~ Update `file_open` `Inputname` `C:\\Users\\rthomas\\ptc_start\\Config_Mapkey_Toggles_L\\layersdatumshide.pro`;\
